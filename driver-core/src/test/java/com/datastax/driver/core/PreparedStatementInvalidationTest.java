...
public class PreparedStatementInvalidationTest extends CCMTestsSupport {
    ...
    @Test
    public void should_update_statement_id_when_metadata_changed_v4() throws Exception {
        Session session = connectWithV4();
        // given
    ...
    @Test
    public void should_update_statement_id_when_metadata_changed_v5() throws Exception {
        Session session = connectWithV5();
        // given
        PreparedStatement ps = session.prepare("SELECT * FROM simpletable WHERE a = ?");
        MD5Digest idBefore = ps.getPreparedId().getResultMetadataId();
        // when
    ...
    @Test(groups = "short")
    public void should_update_statement_id_when_metadata_changed_across_sessions_v5() throws Exception {
        Session session1 = connectWithV5();
        useKeyspace(session1, keyspace);
        Session session2 = connectWithV5();
    ...
    @Test(groups = "short")
    public void should_update_statement_id_when_metadata_changed_across_sessions_v4() throws Exception {
        Session session1 = connectWithV4();
        useKeyspace(session1, keyspace);
        Session session2 = connectWithV4();
        useKeyspace(session2, keyspace);
        ...
        assertThat(id1a).isEqualTo(id1b);
        assertThat(id2a).isEqualTo(id2b);
    ...
    private Session connectWithV4() throws Exception {
        Cluster cluster = register(Cluster.builder()
                .addContactPoints(getContactPoints())
                .withPort(ccm().getBinaryPort())
                .build());
        return register(cluster.connect(keyspace));
    }

    private Session connectWithV5() throws Exception {
        Cluster cluster = register(Cluster.builder()
                .addContactPoints(getContactPoints())
                .withPort(ccm().getBinaryPort())
